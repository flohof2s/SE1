...
import U10.src.BoundingBoxFactory;
import U10.src.MyPoint;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

import static org.junit.jupiter.api.Assertions.*;

import U10.src.MyPrettyRectangle;
...
public class MyPrettyRectangleTest {
	...
	public void testSameIdentity() {
		...
		assertTrue(!right.equals(middle));
	...
	public void testGetBoundingBox( ) {
		...
		assertEquals(new MyPrettyRectangle(1.0,0.0,6.0,4.0), BoundingBoxFactory.calcBoundingBox(rect));
		...
		assertNotNull(BoundingBoxFactory.calcBoundingBox(rect));
		...
		assertEquals(new MyPrettyRectangle(0.0,0.0,0.0,0.0),BoundingBoxFactory.calcBoundingBox(new MyPrettyRectangle[]{}));
			
		// Test, ob die Übergabe eines NULL-Werts erfolgreich abgefangen wurde (Rueckgabe == NULL!)
		// 
		// [ihr Code]

		assertNull(BoundingBoxFactory.calcBoundingBox(null));
